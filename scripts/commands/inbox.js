module.exports.config = { name: "inbox", version: "1.0", permission: 0, credits: "Rebel", description: "Send an image with a message to a user's inbox", category: "general", usages: "inbox", prefix: true, cooldowns: 5, dependencies: "", };
