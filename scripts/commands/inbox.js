module.exports.config = { name: "inbox", version: "1.0", permission: 2, credits: "Rebel", description: "Send an image with a message to a user's inbox", category: "spam", usages: "inbox", prefix: true, cooldowns: 5, dependencies: "", };
...
const imageUrl = "https://drive.google.com/uc?export=download&id=1EfUxyNQzXhItnzvL3qRQWOyaP765nd2m"; // Change this to the correct image URL
