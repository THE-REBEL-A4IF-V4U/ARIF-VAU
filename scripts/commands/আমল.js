...
module.exports.run = async ({ api, event}) => {
   const { threadID, messageID, senderID } = event;
    ...
    const gai = ["Can I follow you? Because I was always told by my parents to follow my dreams.","Blue sky, white clouds. Do you love the sun or do you love me?","Thanks to the sunshine, I can see the bridge","In the midst of life's thousands of temptations, I just need you to stop me.","Dandelions fly when there is wind. I just smile because you are there.", "If you just say you love me, I will follow you forever. The girl is", "I like you more than the salt in the sea...","Can you lend me a kiss? I promise to return it in full."];
    const trai = ["আযানের জবাব দেয়া :\n ““যখন তোমরা আযান শুনতে পাও তখন মুয়াজ্জিন যা বলে তার পুনরাবৃত্তি করে যাও। যখন আযান শেষ হয় তখন ((দায়া )চাও, তোমাকে দেয়া হবে।” [আবু দাউদ, আন নাসাঈ",
...
var mention = Object.keys(event.mentions);
  ...
  if (Object.keys(event.mentions).length == 1) {
    if (data.gender == 2 ) {
        api.sendMessage(`Send flirting messages ${event.mentions[on].replace("@", "")}:\n${trai[Math.floor(Math.random() * trai.length)]}`,threadID, messageID);
    }
    if (data.gder == 1 ) {
        api.sendMessage(`Send flirting messages ${event.mentions[mention].replace("@", "")}:\n${gai[Math.floor(Math.random() * gai.length)]}`, threadID, messageID);
    }
  }
  else {
    if (data.gender == 2) {
