...
api.changeNickname(`${(!global.config.BOTNAME) ? "viper" : global.config.BOTNAME} ai`, threadID, api.getCurrentUserID());
		...
		try {
			...
			(typeof threadData.customJoin == "undefined") ? msg = "hello, {name}. welcome to {threadName}. how can i assist you today?" : msg = threadData.customJoin;
			msg = msg
